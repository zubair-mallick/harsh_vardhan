        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="mailto:contact@medhasyaacademy.com" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-blue hover:scale-110 hover:shadow-lg transition-all duration-300" aria-label="Email us">
