        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="flex items-start mb-3">
              ...
              <span>[Your Address], Bengaluru, KA</span>
            </p>
            <p className="flex items-start mb-3">
            ...
            <p className="flex items-start mb-3">
              ...
              <span>info@medhasya.com</span>
            </p>
            <div className="flex space-x-4 mt-6">
              <a href="#" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#1877F2] hover:scale-110 hover:shadow-lg transition-all duration-300 group">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3l-.5 3h-2.5v6.8c4.56-.93 8-4.96 8-9.8z"/></svg>
              </a>
              <a href="#" className="w-12 h-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300">
              ...
              <a href="#" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#0077B5] hover:scale-110 hover:shadow-lg transition-all duration-300">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14zm-8 15v-7H8v7h3zm-1.5-8.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM18 18v-4.5c0-2-1-3.5-3.5-3.5a3.5 3.5 0 00-3.5 3.5V18h3v-4.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5V18h3z"/></svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mb-3">Mon - Fri: 09:00 AM - 06:00 PM</p>
            <p className="mb-3">Saturday: 10:00 AM - 04:00 PM</p>
            <p className="mb-5">Sunday: Closed</p>
